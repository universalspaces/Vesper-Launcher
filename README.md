...
- Vesper UI integration and pack health checks
- Discord Rich Presence
- Automatic launcher updates
- Local playtime and session tracking
- Installation diagnostics

## Install

Download `Vesper-Launcher-Setup-*.exe` from the latest release and run the installer.
